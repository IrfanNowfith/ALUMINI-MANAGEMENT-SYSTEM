...
public class AlumniManagementSystem extends JFrame {
    ...
    private void inviteAlumniToEvent() {
        try {
            String eventIdInput = JOptionPane.showInputDialog(this, "Enter Event ID:");
            String alumniIdInput = JOptionPane.showInputDialog(this, "Enter Alumni ID:");

            if (eventIdInput == null || alumniIdInput == null) {
                displayMessage("Action canceled.");
                return;
            }

            int eventId = Integer.parseInt(eventIdInput);
            int alumniId = Integer.parseInt(alumniIdInput);
            ...
            displayMessage("Invalid input. Please enter numeric values for IDs.");
        }
    }

    private void viewEventInvites() {
        try {
            String eventIdInput = JOptionPane.showInputDialog(this, "Enter Event ID to View Invites:");
